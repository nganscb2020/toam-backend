    ...
    <div class="detail-grid">
      ...
      <aside>
        <div class="contact-box">
          ...
          <div class="owner">Môi giới phụ trách: <b>${esc(row.owner_name || 'BDSCHÍNHCHỦHCM')}</b></div>
        ...
        <div class="side-note">
          <b>Lưu ý:</b> Thông tin trên do đội ngũ BDSCHÍNHCHỦHCM khảo sát và cập nhật. Vui lòng liên hệ hotline để xác nhận tình trạng mới nhất trước khi đến xem trực tiếp.
        </div>
      </aside>
    </div>`;
}
  ...
  return `
    <div class="detail-grid">
      ...
      <aside>
        <div class="contact-box">
          <h3>Liên hệ tư vấn</h3>
          <div class="owner">Người đăng: <b>${esc(row.owner_name || 'BDSCHÍNHCHỦHCM')}</b></div>
          <a href="tel:0902312009" class="btn-call">📞 Gọi hotline: 090 231 2009</a>
        </div>
        <div class="side-box">
      ...
      <div class="article-main">
        ...
        <div class="article-body">
          ...
          <div class="article-meta">
            ...
            <span>✍️ ${esc(row.owner_name || 'BDSCHÍNHCHỦHCM')}</span>
          </div>
